...
.. admonition:: Guide
   ...
   #. In the console, use :code:`./build/tsunami_lab <number-of-cells>` (Tip: to be sure that you are in the correct console, you can write ./b and press the "tab"-button amd see, if the console completes the path automatically)
