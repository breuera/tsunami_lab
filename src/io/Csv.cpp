...
void tsunami_lab::io::Csv::read_middle_states(
    std::ifstream &io_stream, t_real *&o_heightsL, t_real *&o_momentumsL,
    t_real *&o_heightsR, t_real *&o_momentumsR, t_real *&o_hStar) {
