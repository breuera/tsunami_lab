...
TEST_CASE("Test the one-dimensional Shock-Shock setup.", "[ShockShock1d]")
{
  ...
  REQUIRE(l_shockShock.getBathymetry(2, 0) == -2.0f);
  ...
  REQUIRE(l_shockShock.getBathymetry(2, 2) == -2.0f);
  ...
  REQUIRE(l_shockShock.getBathymetry(4, 0) == -1.0f);
  ...
  REQUIRE(l_shockShock.getBathymetry(4, 2) == -1.0f);
}