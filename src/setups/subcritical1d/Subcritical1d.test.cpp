...
{
  tsunami_lab::setups::Subcritical1d l_subcritical(25,
                                                 55,
                                                 3);
  ...
  REQUIRE(l_subcritical.getMomentumX(2, 0) == 4.42);
  ...
  // x element of 8-12
  REQUIRE(l_subcritical.getHeight(10, 0) == 1.8);

  REQUIRE(l_subcritical.getMomentumX(10, 0) == 4.42);
  ...
  REQUIRE(l_subcritical.getHeight(30, 0) == 25);

  REQUIRE(l_subcritical.getMomentumX(30, 0) == 55);
