 ...
 * @author Mher  (mher. AT uni-jena.de)
 *
 *
 * @section DESCRIPTION
                                                ...
                                                t_real &o_strengthR)
{
  ...
  l_fluxJump[1] = l_fluxR[1] - l_fluxL[1];
...
void tsunami_lab::solvers::FWave::flux(t_real i_h, t_real i_hu, t_real *&o_flux)
{
  o_flux[0] = i_hu;
  o_flux[1] = i_hu * i_hu / i_h + m_gSqrt * (0.5f * i_h * i_h);
}
