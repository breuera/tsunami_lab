...
class tsunami_lab::solvers::F_Wafe {
	private:
		...
		static t_real constexpr c_sqrt = 3.131557121;
		...
		static void height_avg(	t_real 	 i_hL,
					t_real 	 i_hR,
					t_real & o_height);
		...
		static void particle_Velocity_avg(	t_real   i_hL,
							t_real   i_hR,
							t_real   i_huL,
							t_real	 i_huR,
							t_real & o_velocity);
		...
		static void wafeStrengths( 	t_real   i_hL,
						t_real   i_hR,
						t_real   i_huL,
						t_real   i_huR,
						t_real & o_strengthL,
